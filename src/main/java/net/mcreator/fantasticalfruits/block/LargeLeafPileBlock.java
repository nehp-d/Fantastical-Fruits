...
public class LargeLeafPileBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:large_leaf_pile")
	public static final Block block = null;
	public LargeLeafPileBlock(FantasticalFruitsModElements instance) {
		super(instance, 44);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("large_leaf_pile"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:large_leaf_pile"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("large_leaf_pile");
		}
