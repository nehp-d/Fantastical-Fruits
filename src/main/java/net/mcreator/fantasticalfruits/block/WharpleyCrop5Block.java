...
public class WharpleyCrop5Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:wharpley_crop_5")
	public static final Block block = null;
	public WharpleyCrop5Block(FantasticalFruitsModElements instance) {
		super(instance, 146);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("wharpley_crop_5");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 15, 16, 16)).withOffset(offset.x, offset.y, offset.z);
		}
