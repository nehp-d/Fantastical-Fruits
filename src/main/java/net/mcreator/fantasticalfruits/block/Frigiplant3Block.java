...
public class Frigiplant3Block extends FantasticalFruitsModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FrigipomeItem.block, (int) (2)));
		}
