...
public class DesertBrickSlabBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:desert_brick_slab")
	public static final Block block = null;
	public DesertBrickSlabBlock(FantasticalFruitsModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("desert_brick_slab");
		}
