...
public class GreenGrapeVine1Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:green_grape_vine_1")
	public static final Block block = null;
	public GreenGrapeVine1Block(FantasticalFruitsModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_grape_vine_1");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreenGrapesItem.block, (int) (2)));
		}
