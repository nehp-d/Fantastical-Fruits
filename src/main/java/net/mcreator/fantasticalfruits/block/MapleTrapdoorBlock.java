...
public class MapleTrapdoorBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:maple_trapdoor")
	public static final Block block = null;
	public MapleTrapdoorBlock(FantasticalFruitsModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("maple_trapdoor");
		}
