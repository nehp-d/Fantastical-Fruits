...
public class WildWharpleyBlock extends FantasticalFruitsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("wild_wharpley"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:wild_wharpley"), configuredFeature);
		}
	}
	@SubscribeEvent
