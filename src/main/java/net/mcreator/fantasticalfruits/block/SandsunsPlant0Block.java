...
import net.mcreator.fantasticalfruits.procedures.SandsunsGrowProcedure;
...
public class SandsunsPlant0Block extends FantasticalFruitsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sandsuns_plant_0"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:sandsuns_plant_0"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("sandsuns_plant_0");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SandsunsGrowProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
