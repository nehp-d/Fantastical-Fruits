...
public class AubadeberryBlock extends FantasticalFruitsModElements.ModElement {

	@ObjectHolder("fantastical_fruits:aubadeberry")
	public static final Block block = null;

	public AubadeberryBlock(FantasticalFruitsModElements instance) {
		super(instance, 254);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aubadeberry"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:aubadeberry"), configuredFeature);
		}
