...
public class JuniperStairsBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:juniper_stairs")
	public static final Block block = null;
	public JuniperStairsBlock(FantasticalFruitsModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("juniper_stairs");
		}
