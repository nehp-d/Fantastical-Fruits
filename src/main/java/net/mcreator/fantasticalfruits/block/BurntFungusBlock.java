...
public class BurntFungusBlock extends FantasticalFruitsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("burnt_fungus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:burnt_fungus"), configuredFeature);
		}
	}
	@SubscribeEvent
