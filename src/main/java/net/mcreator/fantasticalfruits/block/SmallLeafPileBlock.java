...
public class SmallLeafPileBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:small_leaf_pile")
	public static final Block block = null;
	public SmallLeafPileBlock(FantasticalFruitsModElements instance) {
		super(instance, 45);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("small_leaf_pile"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:small_leaf_pile"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("small_leaf_pile");
		}
