...
public class WharpleyCrop0Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:wharpley_crop_0")
	public static final Block block = null;
	public WharpleyCrop0Block(FantasticalFruitsModElements instance) {
		super(instance, 148);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("wharpley_crop_0");
		}
