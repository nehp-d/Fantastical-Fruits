...
public class MangoLeavesBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:mango_leaves")
	public static final Block block = null;
	public MangoLeavesBlock(FantasticalFruitsModElements instance) {
		super(instance, 110);
	}
