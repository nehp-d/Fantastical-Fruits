...
public class LemonLeavesBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:lemon_leaves")
	public static final Block block = null;
	public LemonLeavesBlock(FantasticalFruitsModElements instance) {
		super(instance, 109);
	}
