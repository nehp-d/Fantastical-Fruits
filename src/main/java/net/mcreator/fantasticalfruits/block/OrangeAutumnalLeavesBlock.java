...
public class OrangeAutumnalLeavesBlock extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:orange_autumnal_leaves")
	public static final Block block = null;
	public OrangeAutumnalLeavesBlock(FantasticalFruitsModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_autumnal_leaves");
		}
