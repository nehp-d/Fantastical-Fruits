...
import net.mcreator.fantasticalfruits.procedures.LimeGrowProcedure;
...
public class LimeLeaves0Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:lime_leaves_0")
	public static final Block block = null;
	public LimeLeaves0Block(FantasticalFruitsModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				LimeGrowProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 100);
		}
	}
