...
public class GreenGrapeVine0Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:green_grape_vine_0")
	public static final Block block = null;
	public GreenGrapeVine0Block(FantasticalFruitsModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_grape_vine_0");
		}
