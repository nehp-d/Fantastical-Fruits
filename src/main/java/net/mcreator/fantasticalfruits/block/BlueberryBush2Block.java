...
import net.mcreator.fantasticalfruits.procedures.BlueberryBushHarvestProcedure;
import net.mcreator.fantasticalfruits.procedures.BlueberryBushAgeProcedure;
...
public class BlueberryBush2Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:blueberry_bush_2")
	public static final Block block = null;
	public BlueberryBush2Block(FantasticalFruitsModElements instance) {
		super(instance, 106);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fantastical_fruits:blueberry_bush_2"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BlueberryBushAgeProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BlueberryBushHarvestProcedure.executeProcedure($_dependencies);
			}
