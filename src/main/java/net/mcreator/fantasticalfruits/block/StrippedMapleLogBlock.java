...
public class StrippedMapleLogBlock extends FantasticalFruitsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 1f).setLightLevel(s -> 0).harvestLevel(0)
