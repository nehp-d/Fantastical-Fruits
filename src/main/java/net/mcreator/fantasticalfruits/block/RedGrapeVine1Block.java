...
import net.mcreator.fantasticalfruits.procedures.GrapeHarvestProcedure;
...
public class RedGrapeVine1Block extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:red_grape_vine_1")
	public static final Block block = null;
	public RedGrapeVine1Block(FantasticalFruitsModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_grape_vine_1");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(RedGrapesItem.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedGrapesItem.block, (int) (2)));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				GrapeHarvestProcedure.executeProcedure($_dependencies);
			}
