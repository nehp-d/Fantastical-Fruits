...
public class MangoItem extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:mango")
	public static final Item block = null;
	public MangoItem(FantasticalFruitsModElements instance) {
		super(instance, 3);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(FantasticalFruitsItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(3.4f).build()));
