...
public class LemonItem extends FantasticalFruitsModElements.ModElement {
	@ObjectHolder("fantastical_fruits:lemon")
	public static final Item block = null;
	public LemonItem(FantasticalFruitsModElements instance) {
		super(instance, 1);
	}
